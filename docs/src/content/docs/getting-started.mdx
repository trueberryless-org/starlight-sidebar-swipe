...
1. `starlight-sidebar-swipe` is a Starlight [plugin](https://starlight.astro.build/reference/plugins/). Install it by running the following command in your terminal:
   ...
   ```sh
   pnpm add starlight-sidebar-swipe
   ```
   ...
   ```sh
   yarn add starlight-sidebar-swipe
   ```
